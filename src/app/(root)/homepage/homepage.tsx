...
import { Search, ShoppingCart, Menu, X, Smartphone, Home, Shirt, Sparkles, Dumbbell } from "lucide-react"
      ...
      <header className="sticky top-0 z-10 bg-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="text-2xl font-bold text-purple-600">Buy Value Store</span>
          </div>
            ...
            {featuredProducts.map((product, index) => (
              <Card key={index}>
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Seller: {product.sellerInfo}</p>
                </CardContent>
                <CardFooter>
                <Link href={`/product/${product._id}`}>
                 <Button className="w-full">View on Seller Site</Button>
                 </Link>
                </CardFooter>
              </Card>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-600 hover:text-purple-600">Featured Products</a></li>
